...
contract("CourseMarketplace", (accounts) => {
  ...
  describe("Normal withdraw", () => {
    ...
    it("Should fail when withdrawing OVERLIMIT the balance", async () => {
      await catchRevert(
  ...
  describe("Emergency widthraw", () => {
    ...
    it("Should have contract funds in the contract owner", async () => {
      await _contract.stopContract({ from: currentOwner }); //contractOwner
  ...
  describe("Selfdestruct", () => {
    ...
    it("Should have 0x bytecode", async () => {
      ...
      assert.equal(bytecode, "0x", "Contract has not been destroyed");
    });
  });
});
